...
import com.pinHouse.server.platform.housing.facility.domain.entity.Library;
import org.springframework.data.mongodb.repository.MongoRepository;
import org.springframework.data.mongodb.repository.Query;

import java.util.List;

public interface LibraryDocumentRepository extends MongoRepository<Library, String> {
