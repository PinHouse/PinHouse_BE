...
import com.pinHouse.server.platform.housing.facility.domain.entity.infra.Walking;
...
public interface WalkingDocumentRepository extends MongoRepository<Walking, String>, GeoFacilityRepository<Walking> {
    ...
    default FacilityType supportsType() { return FacilityType.WALKING; }
