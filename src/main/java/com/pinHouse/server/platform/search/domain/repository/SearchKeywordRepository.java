...
public interface SearchKeywordRepository extends MongoRepository<SearchKeyword, String> {
     ...
     * 키워드로 검색 키워드 조회
     */
    Optional<SearchKeyword> findByKeywordAndScope(String keyword, SearchKeywordScope scope);
     ...
     * @return 인기 검색어 목록
     */
    List<SearchKeyword> findAllByScopeOrderByCountDescLastSearchedAtDesc(SearchKeywordScope scope, Pageable pageable);
