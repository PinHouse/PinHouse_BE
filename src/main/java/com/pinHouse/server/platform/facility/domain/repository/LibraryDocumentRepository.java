...
import com.pinHouse.server.platform.facility.domain.entity.LibraryDocument;
...
public interface LibraryDocumentRepository extends MongoRepository<LibraryDocument, String> {
    ...
    List<LibraryDocument> findByLocation(double longitude, double latitude, double radiusInRadians);
