...
import com.pinHouse.server.platform.facility.domain.entity.ParkDocument;
...
public interface ParkDocumentRepository extends MongoRepository<ParkDocument, String> {
    ...
    List<ParkDocument> findByLocation(double longitude, double latitude, double radiusInRadians);
