package co.kr.pinhouse.domain.housing.notice;
...
import co.kr.pinhouse.domain.housing.notice.application.dto.NoticeDetailFilteredResponse;
...
public interface NoticeApiSpec {
	...
	ApiResponse<UnitTypeCompareResponse> compareUnitTypes(
			...
			@RequestParam(required = false) List<co.kr.pinhouse.domain.housing.facility.domain.entity.FacilityType> nearbyFacilities,
