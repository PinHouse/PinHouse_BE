package com.pinHouse.domain.housing.complex.external;
...
import com.pinHouse.domain.housing.complex.application.util.InterCityResultParser;
import com.pinHouse.domain.housing.complex.application.util.IntraCityResultParser;
