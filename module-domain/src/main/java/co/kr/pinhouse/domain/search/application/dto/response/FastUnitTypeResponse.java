package co.kr.pinhouse.domain.search.application.dto.response;
...
public record FastUnitTypeResponse(
	...
	public static FastUnitTypeResponse from(ComplexDistanceResponse complexDistanceResponse,
		List<FacilityType> facilityTypes, boolean liked) {
