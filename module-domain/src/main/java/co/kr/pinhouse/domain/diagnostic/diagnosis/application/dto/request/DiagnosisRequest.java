package co.kr.pinhouse.domain.diagnostic.diagnosis.application.dto.request;

import java.time.LocalDate;
import java.util.List;

import co.kr.pinhouse.domain.diagnostic.diagnosis.domain.entity.EducationStatus;
import co.kr.pinhouse.domain.diagnostic.diagnosis.domain.entity.HousingOwnershipStatus;
import co.kr.pinhouse.domain.diagnostic.diagnosis.domain.entity.IncomeLevel;
import co.kr.pinhouse.domain.diagnostic.diagnosis.domain.entity.SpecialCategory;
import co.kr.pinhouse.domain.diagnostic.diagnosis.domain.entity.SubscriptionAccount;
...
public record DiagnosisRequest(
	...
	@Schema(description = "생일", example = "1987-06-15")
	...
	@Schema(description = "교육 상태", example = "해당 사항 없음")
	...
	@Schema(description = "특수 계층 목록", example = "[]")
