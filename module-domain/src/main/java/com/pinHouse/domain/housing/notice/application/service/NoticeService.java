package com.pinHouse.domain.housing.notice.application.service;
...
import com.pinHouse.common.exception.code.NoticeErrorCode;
...
import com.pinHouse.common.util.TimeFormatter;
...
import com.pinHouse.domain.housing.notice.application.dto.NoticeDetailFilterRequest;
import com.pinHouse.domain.housing.notice.application.dto.NoticeDetailFilteredResponse;
import com.pinHouse.domain.housing.notice.application.dto.NoticeListRequest;
import com.pinHouse.domain.housing.notice.application.dto.NoticeListResponse;
import com.pinHouse.domain.housing.notice.application.dto.UnitTypeCompareResponse;
import com.pinHouse.domain.housing.notice.application.dto.UnitTypeSortType;
import com.pinHouse.domain.housing.notice.application.usecase.NoticeUseCase;
import com.pinHouse.domain.housing.notice.domain.entity.NoticeDocument;
import com.pinHouse.domain.housing.notice.domain.repository.NoticeDocumentRepository;
...
import com.pinHouse.domain.search.domain.entity.HouseType;
import com.pinHouse.domain.search.domain.entity.RentalType;
	...
	public NoticeDetailFilteredResponse getNotice(String noticeId, NoticeDetailFilterRequest request) {
		...
		if (request.pinPointId() != null && !request.pinPointId().isBlank()) {
			...
			for (ComplexDocument complex : complexes) {
				try {
					com.pinHouse.domain.housing.complex.application.dto.response.DistanceResponse distance =
