...
import com.pinHouse.domain.housing.complex.domain.entity.Deposit;
import com.pinHouse.domain.housing.complex.domain.entity.UnitType;
...
public class ComplexService implements ComplexUseCase {
    ...
    public List<ComplexDocument> loadSortedComplexes(
            String noticeId,
            com.pinHouse.domain.housing.notice.application.dto.UnitTypeSortType sortType
    ) {
    ...
    public List<ComplexDistanceResponse> filterUnitTypesOnly(List<ComplexDistanceResponse> complexes, SearchHistory req) {
        ...
        final List<String> rentalTypeValues = req.getRentalTypes() != null
                ? req.getRentalTypes().stream()
                        .map(com.pinHouse.domain.search.domain.entity.RentalType::getValue)
                        .toList()
                : List.of();
    ...
    public TransitInfoResponse getTransitInfo(String id, String pinPointId) throws UnsupportedEncodingException {
        ...
        com.pinHouse.domain.housing.complex.application.dto.result.RootResult cachedRootResult =
