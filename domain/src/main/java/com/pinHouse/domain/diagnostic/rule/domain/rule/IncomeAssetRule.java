...
public class IncomeAssetRule implements Rule {
    ...
    public RuleResult evaluate(EvaluationContext ctx) {
        ...
        while (iter.hasNext()) {
            ...
            if (noticeType == com.pinHouse.domain.housing.notice.domain.entity.NoticeType.LONG_TERM_JEONSE ||
                noticeType == com.pinHouse.domain.housing.notice.domain.entity.NoticeType.PUBLIC_RENTAL) {
