...
public enum ImageErrorCode implements ErrorCode {
	...
	// ========================
	GCS_PRESIGNED_URL_GENERATION_FAILED(500_301, HttpStatus.INTERNAL_SERVER_ERROR, "이미지 업로드 URL 생성에 실패했습니다."),
	GCS_CLIENT_ERROR(500_302, HttpStatus.INTERNAL_SERVER_ERROR, "GCS 서버와 통신 중 오류가 발생했습니다.");
